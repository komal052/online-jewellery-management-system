...
@Component({
  selector: 'app-e-add-jewellery',
  templateUrl: './e-add-jewellery.component.html',
  styles: [],
  encapsulation : ViewEncapsulation.None,
})
export class EAddJewelleryComponent implements OnInit {
 ...
 insertdetails(form:NgForm)
 {
  ...
  formData.append('jewellery_name',this.jewellerydata.jewellery_name)
    ...
    this.service.InsertJewellery(formData).subscribe(res=>{
      ...
      {
        this.restform(form);
        this.Router.navigate(['/employee/e_show_jewellery']).then(() => {
