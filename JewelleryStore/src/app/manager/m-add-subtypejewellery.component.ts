...
@Component({
  selector: 'app-m-add-subtypejewellery',
  templateUrl: './m-add-subtypejewellery.component.html',
  styles: [
  ]
})
export class MAddSubtypejewelleryComponent implements OnInit {
  ...
  formData.append('description',this.subjewellryData.description)
    ...
    this.service.InsertSubJewellery(formData).subscribe(res=>{
      ...
      {
        this.restform(form);
        this.Router.navigate(['/manager/m_show_subtypejewellery']).then(() => {
