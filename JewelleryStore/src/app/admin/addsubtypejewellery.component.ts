...
@Component({
  selector: 'app-addsubtypejewellery',
  templateUrl: './addsubtypejewellery.component.html',
  styles: [],
  encapsulation : ViewEncapsulation.None,
})
export class AddsubtypejewelleryComponent implements OnInit {
  ...
  formData.append('description',this.subjewellryData.description)
    ...
    this.service.InsertSubJewellery(formData).subscribe(res=>{
      ...
      {
        this.restform(form);
        this.Router.navigate(['/admin/showsubtypejewellery']).then(() => {
