...
@Component({
  selector: 'app-e-add-sale',
  templateUrl: './e-add-sale.component.html',
  styles: [],
  encapsulation : ViewEncapsulation.None,
})
export class EAddSaleComponent implements OnInit {
  ...
  insertDetails(form:NgForm){
    this.service.InsertSale(this.saleData).subscribe(res=>{
      ...
      if(this.insertResponce.result === "success"){
        this.resetForm(form);
        this.router.navigate(['/employee/e_show_sale']).then(() => {
