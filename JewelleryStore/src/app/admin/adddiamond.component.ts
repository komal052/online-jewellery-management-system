...
@Component({
  selector: 'app-adddiamond',
  templateUrl: './adddiamond.component.html',
  styles: [
  ],
  ...
  insertDetails(form:NgForm){
    this.service.InsertDiamond(this.diamondData).subscribe(res=>{
      ...
      if(this.insertResponce.result === "success"){
        this.resetForm(form);
        this.router.navigate(['/admin/showdiamond'],{relativeTo:this.route})
      }else{
        console.log(res);
      }
    },err=>{
   ...
   updateDetails(form:NgForm){
    this.service.UpdateDiamond(this.diamondData).subscribe(res=>{
      ...
      if(this.insertResponce.result === "success"){
        this.resetForm(form);
        this.router.navigate(['/admin/showdiamond']).then(() => {
